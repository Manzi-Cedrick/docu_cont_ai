                ...
                <div className="flex flex-auto">
                    ...
                    <div className="grid flex-auto grid-cols-1 grid-rows-1">
                        ...
                        <ol className="col-start-1 col-end-2 row-start-1 grid grid-cols-1 sm:grid-cols-7 sm:pr-8"
                            style={
                                {gridTemplateRows: '1.1rem repeat(420, minmax(0, 1fr)) auto'}
                        }>
                            <li className="relative mt-px flex sm:col-start-3"
                                style={
                                    {gridRow: '1 / span 12'}
                            }>
                                <a href="#" className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-green-50 p-2 text-xs leading-5 hover:bg-green-100">
                                    <p className="order-1 font-semibold text-green-700">Bug Fix</p>
                                    <p className="text-green-500 group-hover:text-green-700">
                                        <time dateTime="2022-01-12T06:00">12:00 AM</time>
                                    </p>
                                </a>
                            </li>
                            <li className="relative mt-px flex sm:col-start-3"
                                ...
                                <a href="#" className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-pink-50 p-2 text-xs leading-5 hover:bg-pink-100">
                                    <p className="order-1 font-semibold text-pink-700">Flight to Paris</p>
                                    <p className="text-pink-500 group-hover:text-pink-700">
                                        <time dateTime="2022-01-12T07:30">4:00 AM</time>
                                    </p>
                                </a>
                            </li>
                            <li className="relative mt-px hidden sm:col-start-6 sm:flex"
                                style={
                                    {gridRow: '122 / span 24'}
                            }>
                                <a href="#" className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-gray-100 p-2 text-xs leading-5 hover:bg-gray-200">
...
export default CalendarEventZone
